package com.jimin.board.security;
...
// payload: sub (해당 토큰의 주인), lat (토큰이 발행된 시간), exp (토큰이 만료되는 시간)

@Service
public class TokenProvider {
    private static final String SECURITY_KEY = "jwt1secret1key1wlals1for1spring1security1study" ;     //JWT 생성 및 검증을 위한 키
